...
{{--                        <span class="text-muted"><i class="fas fa-shopping-basket fa-sm mx-1"></i>154 orders</span>--}}
                    ...
                    <a href="#" class="btn btn-success shadow-0"> WhatsApp </a>
                ...
                <div class="border rounded-2 px-3 py-2 bg-white">
                    ...
                    <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                        <li class="nav-item d-flex" role="presentation">
                            <a class="nav-link d-flex align-items-center justify-content-center w-100 active" id="ex1-tab-2" data-mdb-toggle="pill" href="#ex1-pills-2" role="tab" aria-controls="ex1-pills-2" aria-selected="true">Warranty info</a>
                        </li>
                        <li class="nav-item d-flex" role="presentation">
